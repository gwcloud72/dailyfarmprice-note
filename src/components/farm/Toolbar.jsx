...
export default function Toolbar({ filters, setFilter, itemOptions, regionOptions, resultCount, reset, canReset, dataSourceLabel }) {
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-3 shadow-sm md:p-4" aria-label="농산물 검색 조건">
