...
const requiredDeps = ['lucide-react', 'recharts', 'dayjs', 'react', 'react-dom'];
...
const forbidden = ['대시보드', 'GPT', 'README', 'GitHub Actions', 'JSON', '개발자', '프리미엄', '멤버십', '프로'];
...
if (!src.includes('ResponsiveContainer') || !src.includes('LineChart')) errors.push('Recharts 차트 컴포넌트 누락');
